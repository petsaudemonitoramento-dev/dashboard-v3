...
def main() -> int:
    ...
    a("")
    a("A cópia versionada deste arquivo descreve o commit **anterior** àquele que")
    a("a introduziu — é inevitável, já que commitá-la muda o commit. O commit que")
    a("ela descreve está declarado abaixo, e é sempre esse o que corresponde ao")
    a("pacote e ao resumo. Para obter o manifesto do commit atual, basta gerar o")
    a("pacote de novo.")
    a("")
    a("## Programa")
    a("")
